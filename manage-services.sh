...
# ==============================================================================
# Script para Gerenciar o Serviço 'auth-service'
# ==============================================================================
#
# Este script gerencia o ciclo de vida do serviço 'auth-service'
# definido no docker-compose.yml do diretório atual.
#
# ==============================================================================

# --- CONFIGURAÇÃO DO PROJETO ---
# Configurações fixas para o serviço 'auth-service'
